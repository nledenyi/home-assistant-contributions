...
Separate issue from the schema-drift fix in this folder. Tracked upstream at [ha_toyota#282](https://github.com/pytoyoda/ha_toyota/issues/282) (opened by `@alpy-nz` after they confirmed, in comments on [#278](https://github.com/pytoyoda/ha_toyota/issues/278), that HA Core RSS grew while the integration was enabled and went flat when they disabled it — with and without the schema-drift fix applied).
