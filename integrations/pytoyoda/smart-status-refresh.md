...
| Status | [pytoyoda#252](https://github.com/pytoyoda/pytoyoda/pull/252) **MERGED 2026-04-27 11:47Z** by deejay1 (rebase-merge, 5 commits preserved + a pre-commit.ci auto-fix on top). [ha_toyota#286](https://github.com/pytoyoda/ha_toyota/pull/286) open, ready-for-review; consumes the now-upstream pytoyoda primitives, awaiting PyPI release for manifest pin. Implemented, deployed live on a 2-vehicle account, validated on a real drive, soaking clean. |
